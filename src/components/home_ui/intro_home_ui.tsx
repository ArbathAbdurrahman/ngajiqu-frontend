    ...
    return (
        <div className="flex flex-row sm:gap-20 gap-1 sm:px-48 px-5 sm:py-10 py-10 bg-[#E8F5E9]">
            <div className="flex flex-1 sm:gap-16 gap-5 flex-col">
                ...
                <p className="text-left text-xs">NgajiQu hadir untuk memudahkan pengajar mengorganisir data santri sehingga orang tua/wali bisa memantau kegiatan TPQ putra-putrinya.</p>
            </div>
